...
Salida:
- LED a un solo color en el display giratorio para producir una imagen con 4 BLADEs.
...
#define BRILLO 50 // Brillo de LEDs 
...
void loop() {
  ...
  for(int i=0;i<leds;i++){
    ...
    tira2.setPixelColor(i,EEPROM.read(angulo_tira2*leds+i),EEPROM.read(angulo_tira2*leds+i),EEPROM.read(angulo_tira2*leds+i));
    tira3.setPixelColor(i,EEPROM.read(angulo_tira3*leds+i),EEPROM.read(angulo_tira3*leds+i),EEPROM.read(angulo_tira3*leds+i));
    tira4.setPixelColor(i,EEPROM.read(angulo_tira4*leds+i),EEPROM.read(angulo_tira4*leds+i),EEPROM.read(angulo_tira4*leds+i));

    //tira.setPixelColor(i,0,0,0);
    //tira2.setPixelColor(i,0,0,0);
    //tira3.setPixelColor(i,0,0,0);

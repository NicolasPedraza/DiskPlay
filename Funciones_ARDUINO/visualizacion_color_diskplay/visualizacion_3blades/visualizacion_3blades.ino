...
Salida:
- LED a diferentes colores en el display giratorio para producir una imagen con 3 BLADEs.
...
#define PIN_BLADE_3  5 // Pin de neopixels Blade 2
...
void loop() {
  ...
  for(int i=0;i<leds;i++){
    ...
    //tira.setPixelColor(i,0,0,0); // Apagar 
